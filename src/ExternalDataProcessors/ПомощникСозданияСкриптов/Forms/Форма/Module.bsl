...
&НаКлиенте
Процедура УстановитьПараметрыНастроекСкрипта(СтрокаСкрипта)
	
	ДеревоКомандПараметров = ДеревоКоманд.ПолучитьЭлементы();	
	
//	Для Каждого ЭлементДерева Из ДеревоКомандПараметров Цикл
//		
//	КонецЦикла;
//	
КонецПроцедуры 
