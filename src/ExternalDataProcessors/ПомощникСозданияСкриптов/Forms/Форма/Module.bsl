...
Процедура РазобратьСтрокуСкрипта()
	...
	ЗаписатьВНаборЭлементовСкрипта(НаборЭлементовСкрипта, 1, КлючСвязи);
	ОпределитьКомандыСкрипта(СтрокаКомманд, ДеревоКоманд, ПозицияКурсораПоиска, НаборЭлементовСкрипта);
...
&НаКлиенте
Процедура ОпределитьКомандыСкрипта(СтрокаКомманд, ЭлементыДерева, ПозицияКурсораПоиска, НаборЭлементовСкрипта)
...
//	ПозицияКурсораПоиска = 1;
	...
	Для Каждого ЭлементДерева Из СтрокиДерева Цикл
		...
		ИначеЕсли ПозицияНайденнойКоманды > ПозицияКурсораПоиска Тогда
			...
			ЗаписатьВНаборЭлементовСкрипта(НаборЭлементовСкрипта, ПозицияНайденнойКоманды, ЭлементДерева.КлючСвязи);
...
//			КонецЕсли;
		...
		ОпределитьКомандыСкрипта(СтрокаКомманд, ЭлементДерева, ПозицияКурсораПоиска, НаборЭлементовСкрипта);
...
&НаКлиенте
Процедура ЗаписатьВНаборЭлементовСкрипта(НаборЭлементовСкрипта, ПозицияКурсораПоиска, КлючСвязи, ДанныеСтроки = Неопределено)
	...
	Если ДанныеСтроки <> Неопределено Тогда
		...
		СтруктураЭлемента.КлючСвязи = КлючСвязи;
	КонецЕсли;
