...
Процедура ЗаполнитьСтрокуПараметра(МассивФорматированныхСтроки, ТекстСкриптаПредставление, СтруктураСтроки)
	...
	РазделительПараметраИАргумнта = " ";
	
	МассивФорматированныхСтроки.Добавить(Новый ФорматированнаяСтрока(РазделительПараметраИАргумнта + СокрЛП(ПредставлениеАргумента), , ЦветАргумента));
	ТекстСкриптаПредставление = ТекстСкриптаПредставление + РазделительПараметраИАргумнта + СокрЛП(ПредставлениеАргумента);
